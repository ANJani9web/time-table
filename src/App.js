...
import { AnjaniTimeTable } from './components/AnjaniTimeTable';
import { EshikaTimeTable } from './components/EshikaTimeTable';
...
function App() {
  return (
    <div className="App">
      <Router>
        <Routes>
          <Route path="/" element={<AnjaniTimeTable/>}/>
          <Route path="/anjani" element={<AnjaniTimeTable/>}/>
          <Route path="/eshika" element={<EshikaTimeTable/>}/>
        </Routes>
      </Router>
    </div>
  // <div>
